...
final class AppColorScheme extends ThemeExtension<AppColorScheme> {
  ...
  // ── Added surfaces ────────────────────────────────────────────────────────
  final Color
  surfaceDeep; // light #FFFFFF  | dark #0D0D1C  — deep feed/nested card bg
  final Color
  surfaceAvatar; // light #F5F0FF  | dark #13102A  — tinted bg behind avatar icons
  final Color
  surfaceDestructive; // light #FFF0F0  | dark #1A0C0C  — danger zone / delete area bg
  final Color
  surfaceInput; // light #FAF8FF  | dark #111120  — text input / textarea bg

  // ─── Overlay ──────────────────────────────────────────────────────────────
  final Color
  overlay; // light #1A1A2E  | dark #0B0B14  — scrim behind modals/dialogs (use with opacity)

  // ─── Content hierarchy (text + icons by emphasis level) ───────────────────
  final Color contentPrimary; // light #3D3060  | dark #C0B8D8  — high emphasis
  final Color
  contentSecondary; // light #8878AA  | dark #7070A0  — medium emphasis
  final Color contentTertiary; // light #B0A8CC  | dark #46466A  — low emphasis
  final Color
  contentDisabled; // light #C0B8D8  | dark #25253A  — non-interactive
  final Color
  contentBrand; // light #6D3FD4  | dark #9D71F0  — brand-colored content
  final Color
  contentError; // light #E25448  | dark #E25448  — error-colored content
  final Color
  contentSuccess; // light #17B26A  | dark #17B26A  — success-colored content
  final Color
  contentWarning; // light #F97316  | dark #F97316  — warning-colored content
  final Color
  contentInfo; // light #EC4899  | dark #EC4899  — info-colored content

  // ── Added content ─────────────────────────────────────────────────────────
  final Color
  contentSubtle; // light #A09AB8  | dark #35354E  — timestamps, captions, status bar labels

  // ─── Borders & dividers ───────────────────────────────────────────────────
  final Color
  borderPrimary; // light #E8E4F0  | dark #25253A  — standard borders
  final Color
  borderSecondary; // light #EDE8FF  | dark #1A1A2E  — light dividers, separators
  final Color
  borderBrand; // light #6D3FD4  | dark #9D71F0  — brand-colored border & divider
  final Color
  borderFocused; // light #6D3FD4  | dark #9D71F0  — keyboard/accessibility focus rings
  final Color
  borderError; // light #E25448  | dark #E25448  — error-colored border & divider

  // ── Added borders ─────────────────────────────────────────────────────────
  final Color
  borderInner; // light #EDE8FF  | dark #1E1E30  — inner dividers within card components
  final Color
  borderCard; // light #E8E2FF  | dark #22223A  — card-specific outer borders
  final Color
  borderBrandMuted; // light #DDD8F5  | dark #6B21A8  — muted brand borders (avatar rings, icon outlines)
  ...
  factory AppColorScheme.light() {
    return const AppColorScheme(
      ...
      backgroundSecondary:
          AppColors.neutral50, // #F5F3FF — lavender-tinted page bg
      backgroundTertiary:
          AppColors.neutral100, // #EDE8FF — subtle section divider bg
      // ── Surfaces ──────────────────────────────────────────────────────────
      ...
      // ── Added surfaces ────────────────────────────────────────────────────
      surfaceDeep:
          AppColors.white, // #FFFFFF — same as primary; no extra depth in light
      surfaceAvatar: AppColors
          .brand50, // #F5F0FF — lightest purple tint behind avatar icons
      surfaceDestructive:
          AppColors.error50, // #FFF0F0 — danger zone / delete area bg
      surfaceInput: AppColors
          .lightSurfaceInput, // #FAF8FF — text input / textarea background
      // ── Overlay ───────────────────────────────────────────────────────────
      overlay: AppColors.brand700, // #1A1A2E — dark purple scrim
      // ── Content ───────────────────────────────────────────────────────────
      contentPrimary: AppColors.neutral900, // #3D3060 — dark purple body text
      contentSecondary:
          AppColors.neutral500, // #8878AA — username / secondary text
      contentTertiary:
          AppColors.neutral400, // #B0A8CC — muted / placeholder text
      ...
      // ── Added content ─────────────────────────────────────────────────────
      contentSubtle: AppColors
          .lightContentSubtle, // #A09AB8 — status bar / very faint text
      // ── Borders ───────────────────────────────────────────────────────────
      ...
      // ── Added borders ─────────────────────────────────────────────────────
      borderInner:
          AppColors.neutral100, // #EDE8FF — inner dividers within cards
      borderCard: AppColors.brand100, // #E8E2FF — card-specific outer border
      borderBrandMuted:
          AppColors.lightBorderMuted, // #DDD8F5 — muted border / phone frame
      // ── Global ────────────────────────────────────────────────────────────
  ...
  factory AppColorScheme.dark() {
    return const AppColorScheme(
      ...
      backgroundSecondary:
          AppColors.neutral900, // #1A1A2E — dark lavender-tinted page bg
      backgroundTertiary:
          AppColors.neutral800, // #2E2E3E — subtle section divider bg
      // ── Surfaces ──────────────────────────────────────────────────────────
      ...
      // ── Added surfaces ────────────────────────────────────────────────────
      surfaceDeep: AppColors
          .neutral800, // #FFFFFF — same as primary; no extra depth in light
      surfaceAvatar: AppColors
          .brand50, // #F5F0FF — lightest purple tint behind avatar icons
      surfaceDestructive:
          AppColors.error50, // #FFF0F0 — danger zone / delete area bg
      ...
      contentSecondary:
          AppColors.neutral300, // #8878AA — username / secondary text
      contentTertiary:
          AppColors.neutral400, // #B0A8CC — muted / placeholder text
      contentDisabled: AppColors.neutral300, // #C0B8D8 — non-interactive text
